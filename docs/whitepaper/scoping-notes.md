# Scoping Notes — Pre-Paper

These notes are the early-semester thinking that became the structure of [`multi-agent-classroom.md`](multi-agent-classroom.md). They are preserved here as a working artifact — the form the argument took before it was reshaped into the formal paper sections. Some of this content has been rewritten or compressed in the paper; some has been inlined verbatim. The paper carries the canonical version; this file carries the original thinking.
