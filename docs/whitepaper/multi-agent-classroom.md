...
| **Student projects** (Tony, Forest, Timer, Imprint, Gus, NodCheck, …) | Reactive | SSE subscription loop | Project-local events | React to the room in a project-specific way | `GET /subscribe/state`, `POST /projects/:id/events` |
